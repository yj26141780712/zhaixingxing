...
import { _decorator, Component, Node, SystemEvent, setDisplayStats, UITransform, EventTouch, Vec3 } from 'cc';
 ...
 * Name = tan_joyStick
 * DateTime = Tue Jan 25 2022 20:31:59 GMT+0800 (中国标准时间)
 * Author = yj261417807
 * FileBasename = tan-joyStick.ts
 * FileBasenameNoExtension = tan-joyStick
 * URL = db://assets/demo/tanchishe/tan-joyStick.ts
...
export class tan_joyStick extends Component {
    ...
    onTouchMove(event: EventTouch) {
        ...
        (this.headNode.getComponent('head') as head).dir = this.dir;
    }
